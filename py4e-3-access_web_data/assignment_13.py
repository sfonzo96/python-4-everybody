...
Actual data: http://py4e-data.dr-chuck.net/comments_1749053.xml (Sum ends with 90)
...
# Check .xml files in order to see the tags structure (commentinfo >> comments > comment > count)
countsList = xmlTree.findall('.//count')
